...
class data_loader:
    ...
    def generate_data(self, datatype='train',
        ...
        if load_saved_data:
            ...
            transition_inputs_currday = \
            np.load("data/transition_inputs_currday_{}_{}.npz".format(self.dataset, datatype))['data']
            ...
            """ save the matrices """
            np.savez_compressed("data/flow_inputs_currday_{}_{}.npz".format(self.dataset, datatype),
                                data=flow_inputs_currday)
            np.savez_compressed("data/transition_inputs_currday_{}_{}.npz".format(self.dataset, datatype),
                                data=transition_inputs_currday)
            np.savez_compressed("data/ex_inputs_currday_{}_{}.npz".format(self.dataset, datatype),
                                data=ex_inputs_currday)
